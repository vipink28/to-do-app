    ...
    return (
        <div className='h-full flex'>
            <div className='w-1/2 bg-slate-900 flex flex-col items-center justify-center'>
                <div className='w-1/2'>
                    <TaskForm isUdpdate={isUpdate} data={latestTask} setIsUpdate={setIsUpdate} />
                </div>
            </div>
            ...
            <div className='w-1/2 bg-teal-100 flex flex-col items-center justify-center'>
                <div className='w-full max-w-md bg-slate-950 text-white p-5'>
                    <div className='flex items-center'>
                        <h3>Latest Task</h3>
                        <button onClick={handleEdit} className='bg-indigo-600 text-white ms-auto px-5 py-2 rounded-sm w-auto flex-grow-0'>Edit</button>
                    </div>
                    <div className='py-5'>
